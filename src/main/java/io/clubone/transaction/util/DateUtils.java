...
public class DateUtils {
	...
	public static final String CST_TIMEZONE = "America/Chicago";

	public static final String PST_TIMEZONE = "America/Los_Angeles";

	public static final String UTC_TIMEZONE = "Europe/London";

	public static final HashMap<String, String> TIMEZONE_MAPPINGS;
	static {
		TIMEZONE_MAPPINGS = new HashMap<String, String>(175);
		//
		// Mappings
		//
