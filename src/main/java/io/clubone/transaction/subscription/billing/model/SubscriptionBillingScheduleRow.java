...
public class SubscriptionBillingScheduleRow {
    ...
    private UUID billingScheduleStatusId;
    ...
    public UUID getBillingScheduleId() {
        return billingScheduleId;
    }

    public void setBillingScheduleId(UUID billingScheduleId) {
    ...
    public BigDecimal getSystemAdjustmentAmount() {
        return systemAdjustmentAmount;
    }

    public void setSystemAdjustmentAmount(BigDecimal systemAdjustmentAmount) {
        this.systemAdjustmentAmount = systemAdjustmentAmount;
    }
    ...
    public UUID getBillingScheduleStatusId() {
        return billingScheduleStatusId;
    }

    public void setBillingScheduleStatusId(UUID billingScheduleStatusId) {
        this.billingScheduleStatusId = billingScheduleStatusId;
    }
    ...
    public UUID getPriceSourceId() {
        return priceSourceId;
    }

    public void setPriceSourceId(UUID priceSourceId) {
    ...
    public Boolean getIsFreezeCycle() {
        return isFreezeCycle;
    }

    public void setIsFreezeCycle(Boolean isFreezeCycle) {
        this.isFreezeCycle = isFreezeCycle;
    }

    public Boolean getIsCancellationCycle() {
        return isCancellationCycle;
    }

    public void setIsCancellationCycle(Boolean isCancellationCycle) {
        this.isCancellationCycle = isCancellationCycle;
    }
    ...
    public void setBilledOn(OffsetDateTime billedOn) {
